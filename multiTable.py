...
from supabseUtil import insert_data_to_supabase
from syntheticDataGenration import generate_sample_data
...
def setupEntityRelationships(metadata):
    ...
    metadata.add_relationship(parent_table_name='accountContact', parent_primary_key='id',
                              child_table_name='accountNotes', child_foreign_key='accountContactId')

    metadata.add_relationship(parent_table_name='accountContact', parent_primary_key='id',
                              child_table_name='callTranscript', child_foreign_key='accountContactId')

    metadata.add_relationship(parent_table_name='account', parent_primary_key='accountId',
                              child_table_name='accountContact', child_foreign_key='accountId')
    metadata.add_relationship(parent_table_name='contact', parent_primary_key='contactId',
                              child_table_name='accountContact', child_foreign_key='contactId')
